...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    // here product.images has not found .That changes is product.image
    // and added rating count and rating
    ...
    div.innerHTML = `<div >
      ...
      <div class="col single-product my-color">
      <div class="card h-100">
        <img src="${image}" class="card-img-top product-image my-color" alt="...">
        <div class="card-body my-color">
          <h5 class="card-title">${product.title.slice(0,20)}</h5>
          <small class=" text-success">Category : ${product.category}</small>
          <h6 class="card-text"> Price :$ ${product.price}</h6>
          <p class="card-text">Rating : <span class="fa fa-star checked"></span> ${product.rating.rate}/5</p>
          <p class="card-text">Tatal Rating :  ${product.rating.count}</p>
        </div>
...
// update delivery charge and total Tax and grandtotal
